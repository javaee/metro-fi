...
public class LongEncodingAlgorithm extends IntegerEncodingAlgorithm {
    ...
    public void encodeToOutputStream(Object data, OutputStream s) throws IOException {
        ...
        encodeToOutputStreamFromIntArray(ldata, s);
    }
    ...
    public final void encodeToOutputStreamFromIntArray(long[] ldata, OutputStream s) throws IOException {
    ...
    public final void encodeToBytes(Object array, int astart, int alength, byte[] b, int start) {
        encodeToBytesFromIntArray((long[])array, astart, alength, b, start);
    }
    
    public final void encodeToBytesFromIntArray(long[] ldata, int lstart, int llength, byte[] b, int start) {
